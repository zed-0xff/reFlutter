...
def patchSource(hashS, ver):
  ...
  code->untag()->monomorphic_unchecked_entry_point_ = offset;""")
        ...
        replaceFileFile('src/third_party/dart/runtime/vm/app_snapshot.cc', 'ASSERT(code->IsCode());', 'app_snapshot.cc')
    ...
    if 27 < ver < 53 and patchDump:
        ...
        replaceFileFile('src/third_party/dart/runtime/vm/class_table.cc',
                        'OS::PrintErr("%" Pd ": %s\\n", i, name.ToCString());',
                        'class_table.27_53.cc')
